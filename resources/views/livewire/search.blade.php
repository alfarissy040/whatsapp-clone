<div>
    <section class="w-full bg-zinc-900 px-4 py-2 relative border-b border-zinc-500" x-data="{search: '', toggle: false}">
        ...
        <input type="search" name="search" id="search" class="py-2 pl-12 pr-5 bg-zinc-800 placeholder:text-zinc-400 text-white w-full ring-none border-none rounded-md" placeholder="Search or start new chat" x-model="search" @keyDown="toggle = true;  $wire.cari()" @blur="search != '' ? toggle=true : toggle=false" :value="search" wire:model="search">
    ...
    {{-- <x-search-modal :search='$data_search'/> --}}
</div>