        ...
        <main class="bg-zinc-800 h-screen w-full flex">
            ...
            <div class="h-full w-full basis-[70%]">
                ...
                <div class="w-full h-full relative">
                    ...
                    <footer class="w-[70%] flex items-center fixed bottom-0 bg-zinc-700 py-3 px-5 gap-x-4"
                    x-data="{ emot:false }">
                        {{-- tools --}}
                        ...
                        {{-- input msg --}}
                        <input type="text" name="msg" id="msg" class="py-2 px-3 text-white placeholder:text-zinc-400 bg-zinc-600 rounded-md border-none w-full" placeholder="Type a message">
                    </footer>
                </div>
            </div>
        </main>
