...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <main class="bg-zinc-800 h-screen w-full flex">
            ...
            <div class="h-full w-full basis-[70%]" x-data>
                {{-- show when no card active --}}
                <div class="w-full h-full flex flex-col justify-center" x-show="!$store.chatPanel.on">
                ...
                {{-- tampilan chat --}}
                <div class="w-full h-full" x-show="$store.chatPanel.on">
                    <livewire:chat-panel />
                </div>
            </div>
        </main>
