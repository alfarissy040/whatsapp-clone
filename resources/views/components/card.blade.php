<div class="card">
    ...
    <div class="card__content">
        <div class="card__content__head">
            <h1>{{ $title }}</h1>
            <small class="text-xs {{ $status == 'false' ? 'text-emerald-500':'text-zinc-500' }}">{{ $time }}</small>
        </div>
        <div class="card__content__body">
            <small class="text-xs {{ $status == 'false' ? 'text-white':'text-zinc-500' }}">{{ $excerpt }}</small>
            <div class="card__content__body__tools">
                ...
                {{-- mute --}}
                @if ($mute == 'true')
                <svg viewBox="0 0 24 24" class="w-5 h-5 text-zinc-500">
                ...
                @endif
                {{-- menu --}}
                <svg xmlns="http://www.w3.org/2000/svg" id="card_menu" class="h-5 w-5 cursor-pointer text-zinc-500" viewBox="0 0 20 20" fill="currentColor">
